...
___CSS_LOADER_EXPORT___.push([module.id, `:root {
    ...
    /* Buttons */
    --secondary-color: #2ecc71; /*used in Submit button hover*/
    --secondary-dark: #27ae60; /*used in Submit button active*/
    --secondary-light: #c8e6c9; /*used in Submit button*/

    --button-hover: #ba181b28; /*used in new task button hover*/
    --button-active: #ba181b5b; /*used in new task button active*/

    --close-button: rgb(169, 169, 169); /*used in dialog close button*/
    --close-button-hover: rgb(136, 136, 136); /*used in dialog close button hover*/
    --close-button-active: rgb(108, 108, 108); /*used in dialog close button active*/

    /* Icons */
    --accent-color: #BA181B; /*used in task delete and edit icons, project delete icon, and in views on the left*/

    /* Scroll bar and slider */
    --accent-light: #E5383B; /*used scroll bar and slider animation*/

    /* Input placeholder and checkboxes */
    --text-muted: #888; /*used input placeholders and in checkbox icon */
    --checkbox-color: green; /*used in checkbox*/
